...
class UserProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_project" do
    assert_difference("UserProject.count") do
      post user_projects_url, params: { user_project: { is_leader: @user_project.is_leader, project_id: @user_project.project_id, time_assigned: @user_project.time_assigned, user_id: @user_project.user_id } }
    end
  ...
  test "should update user_project" do
    patch user_project_url(@user_project), params: { user_project: { is_leader: @user_project.is_leader, project_id: @user_project.project_id, time_assigned: @user_project.time_assigned, user_id: @user_project.user_id } }
